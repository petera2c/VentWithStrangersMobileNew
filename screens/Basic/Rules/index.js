    ...
    <Screen navigation={navigation} style={{ ...styles.pa16 }}>
      <View style={{ ...styles.box, ...styles.pa32 }}>
        ...
        <View>
          ...
          <Text style={{ ...styles.pTag, ...styles.mb8 }}>
            2. No harassment, bullying, or attacking of people through vents,
          ...
          <Text style={{ ...styles.pTag, ...styles.mb8 }}>
            ...
            vents, but all comments must be supportive even if you disagree with
          ...
          <Text style={{ ...styles.pTag, ...styles.mb8 }}>6. Have fun! :)</Text>
        </View>
      </View>
    </Screen>
  );
