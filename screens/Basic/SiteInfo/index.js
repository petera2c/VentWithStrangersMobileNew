  ...
  return (
    <Screen navigation={navigation} style={{ ...styles.pa16 }}>
      <View style={{ ...styles.box, ...styles.pa32 }}>
        ...
        <View style={{ ...styles.mb16 }}>
          <TouchableOpacity onPress={() => navigation.jumpTo("QuoteContest")}>
            <Text style={{ ...styles.titleSmall, ...styles.mb8 }}>
              Daily Feel Good Quote Contest
            </Text>
          </TouchableOpacity>
          <Text style={{ ...styles.pTag }}>
            Every day we display a feel good quote. The winner from this contest
            will be show cased for the following day. Submit your quote to
            potentially win.
          </Text>
        </View>
        ...
        <View style={{ ...styles.mb16 }}>
          <Text style={{ ...styles.titleSmall, ...styles.tac, ...styles.mb8 }}>
            ...
            <View style={{ ...styles.fullCenter }}>
              ...
              <View>
                {badgeDescriptions[activeBadge].benefits.map(
                  (benefit, index) => (
                    <Text key={index} style={{ ...styles.pTag, ...styles.tac }}>
                      {benefit}
                    </Text>
                  )
                )}
        ...
        <View style={{ ...styles.mb16 }}>
          ...
          <View style={{ ...styles.pl16 }}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("NewVent")}>
              <Text style={{ ...styles.pTag, ...styles.mb8 }}>
        ...
        <View style={{ ...styles.mb16 }}>
          ...
          <View style={{ ...styles.pl16 }}>
            <Text style={{ ...styles.pTag, ...styles.mb8 }}>
              <Text style={{ ...styles.colorGreen }}>+4</Text> For an upvote on
              your comment
            </Text>
            <Text style={{ ...styles.pTag, ...styles.mb8 }}>
              <Text style={{ ...styles.colorGreen }}>+4</Text> For an upvote on
