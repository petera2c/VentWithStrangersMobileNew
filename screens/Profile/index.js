    ...
    <Screen goBack navigation={navigation} style={{ ...styles.pa16 }}>
      {userID && (
        <View style={{ ...styles.box, ...styles.mb16, ...styles.pa16 }}>
          ...
          <View
            style={{ ...styles.flexRow, ...styles.alignCenter, ...styles.wrap }}
          >
              ...
              <View style={{ ...styles.flexRow }}>
                ...
                {userInfo.gender && (
                  <View style={{ ...styles.mt16, ...styles.mr16 }}>
                    ...
                    <Text style={{ ...styles.pTag }}>{userInfo.gender}</Text>
                  </View>
                )}
                {userInfo.pronouns && (
                  <View style={{ ...styles.mt16, ...styles.mr16 }}>
                    ...
                    <Text style={{ ...styles.pTag }}>{userInfo.pronouns}</Text>
                  </View>
                )}
              </View>
            )}
          ...
          {userInfo.bio && (
            <View style={{ ...styles.mt16 }}>
              <Text style={{ ...styles.titleSmall, ...styles.mb8 }}>Bio</Text>
          ...
          {(userInfo.education !== undefined ||
            ...
            <View style={{ ...styles.flexRow, ...styles.wrap, ...styles.mt16 }}>
              {userInfo.education !== undefined && (
                <View
                  style={{
              ...
              {userInfo.religion !== undefined && (
                ...
                >
                  <FontAwesomeIcon
                    ...
                    style={{ ...styles.colorGrey1, ...styles.mr8 }}
                  />
                  <Text style={{ ...styles.pTag }}>{userInfo.religion}</Text>
                </View>
              )}
            </View>
          )}
      ...
      {!postsSection && (
        <View className="x-fill column">
          ...
          {comments && comments.length === 0 && <Text>No comments found.</Text>}
          {canLoadMoreComments && (
            <TouchableOpacity
              block
              className="mt16"
